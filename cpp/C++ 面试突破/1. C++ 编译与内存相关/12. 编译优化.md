...
为了告诉编译器分支是否容易被执行，可以使用 `C++20` `[[likely]]` 和 `[[unlikely]]`:[https://en.cppreference.com/w/cpp/language/attributes/likely](https://en.cppreference.com/w/cpp/language/attributes/likely)
