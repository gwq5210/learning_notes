...
int main(int argc, char *argv[]) {
  ...
  for (;;) {
    ...
    nread = recvfrom(sfd, buf, buf_size * cnt, 0, (struct sockaddr *)&peer_addr, &peer_addr_len);
    ++cnt;
    ...
    s = getnameinfo((struct sockaddr *)&peer_addr, peer_addr_len, host, NI_MAXHOST, service,
